...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[45rem] md:h-[65rem] flex flex-col items-center justify-center relative p-2 md:p-20 mt-10 md:mt-0"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  <motion.div
    ...
    className="max-w-5xl md:mt-8 mt-10 mx-auto h-[28rem] md:h-[40rem] w-full border-2 md:border-4 border-primary/30 p-2 md:p-6 bg-card rounded-[20px] md:rounded-[30px] shadow-2xl relative z-10"
  >
